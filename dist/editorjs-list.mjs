...
function nn(e, t, n = void 0) {
  ...
  return function() {
    ...
    !s && n.leading === !1 && (s = u);
    const c = t - (u - s);
    return r = this, i = arguments, c <= 0 || c > t ? (l && (clearTimeout(l), l = null), s = u, a = e.apply(r, i), l === null && (r = i = null)) : !l && n.trailing !== !1 && (l = setTimeout(o, c)), a;
  };
}
...
class v {
  ...
  renderWrapper(t) {
    let n;
    return t === !0 ? n = d.make("ol", [v.CSS.wrapper, v.CSS.orderedList]) : n = d.make("ol", [v.CSS.orderedList, v.CSS.itemChildren]), n;
  }
  /**
   ...
   */
  renderItem(t, n) {
    const r = d.make("li", v.CSS.item), i = d.make("div", v.CSS.itemContent, {
      innerHTML: t,
...
class b {
  ...
  renderWrapper(t) {
    let n;
    return t === !0 ? n = d.make("ul", [b.CSS.wrapper, b.CSS.unorderedList]) : n = d.make("ul", [b.CSS.unorderedList, b.CSS.itemChildren]), n;
  }
  /**
   * Redners list item element
   * @param content - content used in list item rendering
...
function Un(e, t, n, r, i) {
  ...
  var o = l.cloneContents(), u = document.createElement("div");
  u.appendChild(o);
  var c = (a = u.textContent) !== null && a !== void 0 ? a : "";
  return c;
}
...
function Vn(e, t) {
  ...
  if (t === void 0 && (t = !0), (0, Gn.isNativeInput)(e)) {
    ...
    if (o(c)) {
      for (; o(c) && c.nodeType !== Node.TEXT_NODE; )
        c = t ? c.firstChild : c.lastChild;
      if (o(c) && c.nodeType === Node.TEXT_NODE) {
        var h = (r = (n = c.textContent) === null || n === void 0 ? void 0 : n.length) !== null && r !== void 0 ? r : 0, i = t ? 0 : h;
        a.setStart(c, i), a.setEnd(c, i);
      } else
        s(e, t);
    } else
      s(e);
...
class K {
  ...
  get currentItem() {
    ...
    if (!t)
      return null;
    let n = t.anchorNode;
    return !n || (_(n) || (n = n.parentNode), !n) || !_(n) ? null : n.closest(`.${p.item}`);
  }
  /**
  ...
  get currentItemLevel() {
    ...
    for (; n !== null && n !== this.listWrapper; )
      _(n) && n.classList.contains(p.item) && (r += 1), n = n.parentNode;
    return r + 1;
  }
  /**
   ...
   */
  merge(t) {
    const n = this.block.holder.querySelectorAll(`.${p.item}`), r = n[n.length - 1], i = N(r);
   ...
   */
  unshiftItem(t) {
    if (!t.parentNode || !_(t.parentNode))
      return;
  ...
  addTab(t) {
    ...
    if (!n)
      return;
    if (((l = this.config) == null ? void 0 : l.maxLevel) !== void 0) {
      const o = this.currentItemLevel;
      if (o !== null && o === this.config.maxLevel)
        return;
    }
    ...
    if (i)
      ...
      const o = this.renderer.renderWrapper(!1);
      o.appendChild(n), y(n).forEach((c) => {
        o.appendChild(c);
      }), r.appendChild(o);
    }
    z(n);
...
class G {
  ...
  get listStyle() {
    var n;
    const t = this.data.style || this.defaultListStyle;
    return t === "checklist" ? ((n = this.config) == null ? void 0 : n.checklists) === !0 ? "checklist" : "unordered" : t;
  }
  /**
   * Set list style
  ...
  static joinRecursive(t) {
    return console.log("data", t), t.items.map((n) => `${n.content}: ${G.joinRecursive(n)}`).join("__ITEMS__");
  }
  /**
  ...
  renderSettings() {
    ...
    if (((n = this.config) == null ? void 0 : n.checklists) === !0 && t.push({
    ...
    }), ((r = this.config) == null ? void 0 : r.customization) === !0 && this.listStyle === "ordered") {
      const i = or(
        (s) => this.changeStartWith(Number(s)),
        {
      ...
      P.forEach((s, o) => {
        ...
        this.defaultCounterTypes.includes(u) && l.children.items.push({
          ...
          closeOnActivate: !0,
          onActivate: () => {
            this.changeCounters(P.get(o));
          }
        });
      }), l.children.items.length > 1 && a.push(l), t.push({ type: "separator" }, ...a);
    }
    return t;
  }
  /**
