...
function Mt(e) {
  var t = window.getComputedStyle(e), n = parseFloat(t.fontSize), r = parseFloat(t.lineHeight) || n * 1.2, i = parseFloat(t.paddingTop), a = parseFloat(t.borderTopWidth), l = parseFloat(t.marginTop), s = n * 0.8, o = (r - n) / 2, c = l + a + i + o + s;
  return c;
}
(function(e) {
...
function nn(e, t, n = void 0) {
  ...
  return function() {
    ...
    !s && n.leading === !1 && (s = c);
    const u = t - (c - s);
    return r = this, i = arguments, u <= 0 || u > t ? (l && (clearTimeout(l), l = null), s = c, a = e.apply(r, i), l === null && (r = i = null)) : !l && n.trailing !== !1 && (l = setTimeout(o, u)), a;
  };
}
...
function Un(e, t, n, r, i) {
  ...
  var o = l.cloneContents(), c = document.createElement("div");
  c.appendChild(o);
  var u = (a = c.textContent) !== null && a !== void 0 ? a : "";
  return u;
}
...
function Vn(e, t) {
  ...
  if (t === void 0 && (t = !0), (0, Gn.isNativeInput)(e)) {
    ...
    var s = function(g, w) {
      ...
      return g != null;
    }, c = e.childNodes, u = t ? c[0] : c[c.length - 1];
    if (o(u)) {
...
class z {
  ...
  save(t) {
    const n = t ?? this.listWrapper, r = (l) => y(l).map((o) => {
      const c = C(o), u = this.renderer.getItemContent(o), h = this.renderer.getItemMeta(o), g = c ? r(c) : [];
      return {
        content: u,
        meta: h,
        items: g
  ...
  pasteHandler(t) {
    ...
    const a = (l) => Array.from(l.querySelectorAll(":scope > li")).map((o) => {
      var g;
      const c = o.querySelector(":scope > ol, :scope > ul"), u = c ? a(c) : [];
      return {
  ...
  mergeItemWithPrevious(t) {
    ...
    const c = n || i, u = C(c) ?? this.renderer.renderWrapper(!1);
    n ? o.forEach((h) => {
      u.appendChild(h);
    }) : o.forEach((h) => {
      u.prepend(h);
    }), C(c) === null && a.appendChild(u), t.remove();
  }
  /**
  ...
  addTab(t) {
    ...
    const i = C(r);
    if (i)
      i.appendChild(n), y(n).forEach((c) => {
        i.appendChild(c);
      });
    else {
      const o = this.renderer.renderWrapper(!1);
      o.appendChild(n), y(n).forEach((u) => {
        o.appendChild(u);
      }), r.appendChild(o);
    }
    K(n);
